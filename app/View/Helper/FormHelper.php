 ...
 */
	public function error($field, $text = null, $options = array()) {
		$defaults = array('wrap' => true, 'class' => 'help-inline error-message', 'escape' => true);
 ...
 */
	protected function _parseOptions($options) {
		if(@$options['div'] == false){
			...
			$options = array_merge(
				array('before' => null, 'between' => '<div class="controls">', 'after' => '</div>', 'format' => null),
				$this->_inputDefaults,
				$options
			);
		}
 ...
 */
	protected function _divOptions($options) {
		if ($options['type'] === 'hidden' || $options == false) {
			return array();
		}
