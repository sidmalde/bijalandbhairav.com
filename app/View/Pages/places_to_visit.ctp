...
<table class="table table-bordered">
	<tr>
		<th>The Mezquita</th>
		<td>Once the second-largest Mosque in the Islamic world, this now enjoys a curious status as a cathedral-within-a-mosque, though its instantly recognisable hallmark are the stripey brick arches  of the Moorish-era temple.</td>
	</tr>
	<tr>
		<th>Alcazar</th>
		<td>The big attraction here are the gardens, laid out in descending terraces with typical Islamic rectangular pools - some of the most beautiful in Andalucia.</td>
	</tr>
	<tr>
		<th>La Judería (Jewish Quarter)</th>
		<td>A fascinating network of narrow lanes that are full of shops, galleries, historic sites - the 14th century synagogue in Calle de los Judios, one of only three originals remaining in Spain; the statue of Maimonides, a Sephardic Jewish Philosopher and Astronomer, born in Córdoba in 1135 or 1138; and la casa sefardi (a Sephardic example of a house).</td>
	</tr>
	<tr>
		<th>Torre de la Calahorra</th>
		<td>Situated at the end of the Roman bridge, the tower's museum offers a fascinating insight into life in the Córdoba - and great views.</td>
	</tr>
	<tr>
		<th>Museo Romero de Torres</th>
		<td>This is a wonderful small art gallery housed in a beautiful, historic former convent. It contains works from one artist and shows the progression over his life's work.</td>
	</tr> 
	<tr>
		<th>Madinat al-Zahra (Azahara)</th>
		<td>A restored Moorish city (City of the Flowers) just outside Córdoba. </td>
	</tr>
	<tr>
		<th>Plaza del Potro</th>
		<td>In the 15th-century Posada del Potro, you'll find the new Centro de Flamenco Fosforito.</td>
	</tr>
	<tr>
		<th>Palacio del Marques de Viana</th>
		<td>Elegant family palace with 14 patios - if you haven´t seen enough already.</td>
	</tr>
	<tr>
		<th>Jardin Botanico</th>
		<td>For further flora appreciation, the Botanical Gardens will be bursting with spring colour in May, and feature a shady arboretum.</td>
	</tr>
	<tr>
		<th>Callejon de las Flores </th>
